     ...
     public WebDriver initDriver() throws IOException {
         ...
         switch (browserType) {
             ...
             case YANDEX:
                 ...
                 options.setBinary("C:\\Users\\alexe\\AppData\\Local\\Yandex\\YandexBrowser\\Application\\browser.exe");
                 driver = new ChromeDriver(options);
                 break;
             default:
                 throw new IllegalArgumentException("Browser undefined: " + browserType);
